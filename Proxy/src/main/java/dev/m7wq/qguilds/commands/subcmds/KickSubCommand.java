...
public class KickSubCommand implements SubCommand {
    ...
    public void jobLoad(ProxiedPlayer sender, String... arg) {
        ...
        HashSet<String> canKick = new HashSet<>(cfg.getConfigures(ConfigurationManager.Configure.CAN_KICK));



        if (!canKick.contains(guildsManager.getPlayerRole(sender.getName()))){
