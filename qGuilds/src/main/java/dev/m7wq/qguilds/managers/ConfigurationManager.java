...
public class ConfigurationManager {
    ...
    public String getMessage(Player player, Message message){
    ...
    public List<String> getMessages(Player player, Message message){

        List<String> list = new ArrayList<>();

        getMessagesConfig().getStringList(message.getKey()).forEach(message1 -> {
            list.add(PlaceholderAPI.setPlaceholders(player,message1));
        });

        return list;
    }

    public String getConfigure(Player player,Configure configure){
