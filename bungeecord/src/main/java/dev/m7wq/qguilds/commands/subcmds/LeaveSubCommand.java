...
public class LeaveSubCommand implements SubCommand {
    ...
    public void jobLoad(ProxiedPlayer sender, String... arg) {
        ...
        if(Plugin.getInstance().getGuildsManager().getPlayerRole(sender.getName()).equals(Plugin.getInstance().getGuildsManager().getPlayerGuild(sender.getName()).getHighestRole())){
