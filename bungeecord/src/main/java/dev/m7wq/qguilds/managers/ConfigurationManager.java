...
public class ConfigurationManager {
    ...
    public enum Message{
        ...
        RECOLOR_ROLE("recolorRole"),
        PERMISSION_EDITOR("permissionEditor"),
        DELETE_ROLE("deleteRole"),
        UPGRADE_ARROW("arrows.upgrade"),
        DEGRADE_ARROW("arrows.degrade"),
        EMPTY_ROLES_LINE("emptyLine"),
        CREATED_ROLE_LINE("created-role"),
        DEFAULT_ROLE_LINE("default-role"),
        ROLES_LIST("roles-list"),
        ON_HIGHEST_RANK("he-is-on-higher-rank"),
